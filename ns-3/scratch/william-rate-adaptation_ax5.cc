...
main(int argc, char* argv[])
{
    ...
    std::string standard = "802.11ax";  // PADRAO WI-FI USADO
    ...
    else if (standard == "802.11n-2.4GHz" || standard == "802.11n-5GHz" || standard == "802.11ac" || standard == "802.11be" || standard == "802.11ax")
    {

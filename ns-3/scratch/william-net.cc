...
main(int argc, char* argv[])
{
    ...
    if (useRts)
    {
        // CONFIGURA O USO DO RTS/CTS
        Config::SetDefault("ns3::WifiRemoteStationManager::RtsCtsThreshold", StringValue("0"));
        Config::SetDefault("ns3::WifiDefaultProtectionManager::EnableMuRts", BooleanValue(true));
    }

    // CONFIGURA OS DIFERENTES TIPOS DE ACK SEQUENCE
    ...
    // MONTA O CABECALHO DAS SAIDAS DE DADOS
    ...
    //{
        ...
        // {
            ...
            // {
                ...
                // VALIDA SE AS FREQUENCIAS N SAO IGUAIS 
                ...
                // PARA CADA FREQUENCIA USADA EM CADA LINK, CONFIGURA O CANAL
                ...
                if (udp)
                {
                    ...
                    for (std::size_t i = 0; i < nStations; i++)
                    {
                        ...
                        // UdpClientHelper client2(serverInterfaces.GetAddress(i), port2);
                        ...
                        // ApplicationContainer clientApp2 = client2.Install(clientNodes.Get(i));
